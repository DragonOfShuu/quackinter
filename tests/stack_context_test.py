...
def test_generated_lines(line_offset: int):
    ...
    ducky_code: list[str] = cast(list[str],"""HELLO_WORLD 0
HELLO_WORLD 1
HELLO_WORLD 2
...
READ_BACK""".split('\n'))
    ...
    def execute_read_back(command_self: "Command", stack: "Stack", cmd: str, data: str):
        ...
        assert stack_context.current_line_index == line_offset + 6 - 1 + empty_lines
        ...
        assert back_one_line.line_index == line_offset + 5 - 1 + empty_lines
